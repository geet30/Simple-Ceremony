...
class Booking extends Model
{
    ...
    protected $fillable = [
        ...
        'full_name_of_parent_1' ,'full_name_of_parent_2','full_name_of_sponsor_1','full_name_of_sponsor_2','calendar_dayslot_id','price_info','voucher_number','voucher_price'
    ];
    protected $casts = [
    ...
    {
        return $this->hasOne(GiftVoucher::class, 'voucher_number', 'voucher_number');
    }
