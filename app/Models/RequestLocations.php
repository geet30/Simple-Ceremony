...
{
    use HasFactory;
    protected $fillable = ['username','type','celebrant_id','name','phone','country_code','email','event_date','event_start_time','name','address','town','post_code','state','general_location','direction','coordinates','parking_details','parking_cost','status','celebrant_id','loc_number','key_advances','price','cover_image','custom_terms','why_this_location','weather_option','getting_there','custom_location','custom_location_id','latitude','longitude'];
