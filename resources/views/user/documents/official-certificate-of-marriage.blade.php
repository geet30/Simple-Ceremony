                            ...
                            <tr>
                                <td>
                                    <table align="left" border="0" cellpadding="0" cellspacing="10" height="100%"
                                        width="100%">
                                        <tr>
                                            <td style="font-size: 12px; color: black;text-align: left;width: 130px;">Date
                                        ...
                                        <tr>
                                            <td style="font-size: 12px; color: black;text-align: left;width: 130px;">At
                                            </td>
                                            <td style="font-size: 18px; color: black; font-weight: bold;padding-bottom: 15px;padding-top: 15px;">
                                        ...
                                        <tr>
                                            <td style="font-size: 12px; color: black;text-align: left;width: 130px;">
                                                Ceremony used
                                            </td>
                                            <td style="font-size: 18px; color: black; font-weight: bold;padding-bottom: 15px;padding-top: 15px;">
                                        ...
                                        <tr>
                                            <td>
                                                <table align="left" border="0" cellpadding="0" cellspacing="10"
                                                            ...
                                                            <div style="    display: flex;">
                                                                <div
                                                                    ...
                                                                    <input type="checkbox" class="checkbox" id="vehicle1"
                                                                        ...
                                                                        {{ $person1 && $person1['person_description'] == 1 ? 'checked="checked"' : '' }} style="margin-right: 10px;">
                                                                    <label
                                                                ...
                                                                <div
                                                                    ...
                                                                    <input type="checkbox" class="checkbox" id="vehicle2"
                                                                        ...
                                                                        {{ $person1 && $person1['person_description'] == 2 ? 'checked="checked"' : '' }} style="margin-right: 10px;">
                                                                    <label
                                                                        style="font-size: 12px; color: black; font-weight: normal; line-height: 19px;"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <input type="checkbox" class="checkbox" id="vehicle3"
                                                                        ...
                                                                        {{ $person1 && $person1['person_description'] == 3 ? 'checked="checked"' : '' }} style="margin-right: 10px;">
                                                                    <label
                                                                        style="font-size: 12px; color: black; font-weight: normal; line-height: 19px;"
                                                            ...
                                                            <div style="    display: flex;">
                                                                <div style="margin-right: 12px;display: flex">
                                                                    <input type="checkbox" class="checkbox"
                                                                        ...
                                                                        {{ $person2 && $person2['person_description'] == 1 ? 'checked="checked"' : '' }} style="margin-right: 10px;">
                                                                    <label
                                                                        style="font-size: 12px; color: black; font-weight: normal ; line-height: 19px;"
                                                                ...
                                                                <div style="margin-right: 12px;display: flex">
                                                                    <input type="checkbox" class="checkbox"
                                                                        ...
                                                                        {{ $person2 && $person2['person_description'] == 2 ? 'checked="checked"' : '' }} style="margin-right: 10px;">
                                                                    <label
                                                                        style="font-size: 12px; color: black; font-weight: normal; line-height: 19px;"
                                                                ...
                                                                <div style="margin-right: 12px;display: flex"> <input
                                                                        ...
                                                                        {{ $person2 && $person2['person_description'] == 3 ? 'checked="checked"' : '' }} style="margin-right: 10px;">
                                                                    <label
                                                                        style="font-size: 12px; color: black; font-weight: normal; line-height: 19px;"
                                                            ...
                                                            <div style="    display: flex;margin-bottom: 20px;">
                                                                <div
                                                                    ...
                                                                    <input type="checkbox" class="checkbox"
                                                                        ...
                                                                        {{ $person1 && $person1['conjugal_status'] == 1 ? 'checked="checked"' : '' }} style="margin-right: 10px;">
                                                                    <label
                                                                ...
                                                                <div style=" width:50%;display: flex;align-self:center">
                                                                    <input type="checkbox" class="checkbox"
                                                                        ...
                                                                        {{ $person1 && $person1['conjugal_status'] == 4 ? 'checked="checked"' : '' }} style="margin-right: 10px;">
                                                                    <label
                                                                        style="font-size: 12px; color: black; font-weight: normal; line-height: 19px;"
                                                            ...
                                                            <div style="    display: flex;">
                                                                <div
                                                                    ...
                                                                    <input type="checkbox" class="checkbox"
                                                                        ...
                                                                        {{ $person1 && $person1['conjugal_status'] == 2 ? 'checked="checked"' : '' }} style="margin-right: 10px;">
                                                                    <label
                                                                        style="font-size: 12px; color: black; font-weight: normal; line-height: 19px;"
                                                                ...
                                                                <div style=" width:50%;display: flex;align-self:center">
                                                                    <input type="checkbox" class="checkbox"
                                                                        ...
                                                                        {{ $person1 && $person1['conjugal_status'] == 3 ? 'checked="checked"' : '' }} style="margin-right: 10px;">
                                                                    <label
                                                                        style="font-size: 12px; color: black; font-weight: normal;  line-height: 13px;"
                                                                        for="value14"> Divorce pending</label>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>&nbsp;</td>
                                                        <td style="font-size: 18px; color: black; font-weight: bold;padding-bottom: 15px;padding-top: 15px;">
                                                            ...
                                                            <div style="    display: flex;">
                                                                ...
                                                                <div style=" width:50%;display: flex;align-self:center">
                                                                    ...
                                                                    <label
                                                                        style="font-size: 12px; color: black; font-weight: normal;  line-height: 13px;"
                                                                        for="value18"> Divorce pending</label>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td style="font-size: 12px; color: black;text-align: left;">Parent
                                                            1’s
                                                        ...
                                                        ?>
                                                            ...
                                                            @if (isset($button) && $button)
                                                                <button data-bs-toggle="modal"
                                                                    ...
                                                                    onclick="readySignature('person1signaturePad')" style="border: 0;background: #62CBC9;color: #fff;border-radius: 5px;padding: 5px 20px;">Edit</button>
                                                        ...
                                                        <td style="font-size: 18px; color: black; font-weight: bold;padding-bottom: 15px;padding-top: 15px;">
                                                            ...
                                                            @if (isset($button) && $button)
                                                                <button data-bs-toggle="modal"
                                                                    ...
                                                                    onclick="readySignature('person2signaturePad')" style="border: 0;background: #62CBC9;color: #fff;border-radius: 5px;padding: 5px 20px;">Edit</button>
                                                                @include('user.documents.signature-modal', [
                                                            ...
                                                            @if (isset($button) && $button)
                                                                @if (Auth::user()->user_type != 2)
                                                                    <button data-bs-toggle="modal"
                                                                        ...
                                                                        onclick="readySignature('person1WitnesssignaturePad')" style="border: 0;background: #62CBC9;color: #fff;border-radius: 5px;padding: 5px 20px;">Edit</button>
                                                                    @include('user.documents.signature-modal', [
                                                            ...
                                                            @if (isset($button) && $button)
                                                                @if (Auth::user()->user_type != 2)
                                                                    <button data-bs-toggle="modal"
                                                                        ...
                                                                        onclick="readySignature('person2WitnesssignaturePad')" style="border: 0;background: #62CBC9;color: #fff;border-radius: 5px;padding: 5px 20px;">Edit</button>
                                                                    @include('user.documents.signature-modal', [
                                        ...
                                        <tr>
                                            <td>
                                                <table align="left" border="0" cellpadding="0" cellspacing="10"
                                                    ...
                                                    <tr>
                                                        <td
                                                            style="font-size: 12px; color: black;text-align: left;width:130px">Celebrant’s
                                                            signature</td>
                                                        <td style="font-size: 18px; color: black; font-weight: bold;padding-bottom: 15px;padding-top: 15px;">
                                                            @if ($person1 && $person1->marriageDocumentPdfOfficialMarriageCertificate)
                                                            ...
                                                            @if (isset($button) && $button)
                                                                @if (Auth::user()->user_type != 2)
                                                                    <button data-bs-toggle="modal"
                                                                        ...
                                                                        onclick="readySignature('celebrantSignaturePad')" style="border: 0;background: #62CBC9;color: #fff;border-radius: 5px;padding: 5px 20px;">Edit</button>
                                                                    @include('user.documents.signature-modal', [
