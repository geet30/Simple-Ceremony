            ...
            <div class="card-body">
               ...
               <form class="d-flex w-100 mt-4  add-ons-detail">
                  ...
                  <div class="ms-2 col-9 col-xl-10">
                     <h2 class="subheader-3 neutral-100 mb-0 ms-2">Fill this dropdown</h2>
                     <div class="row w-100 mt-3 mb-4">
                        <div class="col-12 col-md-7 col-xl-6">
                           <label for="witnessed" class="form-label small-text2 col-12 mb-2 ms-2">Did you electronically sign and have your signature
                           witnessed on this website?</label>
                           <select name="witnessed" id="witnessed" class="js-placeholder-single-input form-control col-12">
                     ...
                     <div class="row w-100 mb-4">
                        <div class="col-12 col-md-6 col-xl-5">
                           <label for="NoIM" class="form-label small-text2 col-12 mb-2 ms-2">How did you have the NoIM witnessed?</label>
                           <select name="NoIM" id="NoIM" class="js-placeholder-single-input form-control col-12">
                     ...
                     <div class="row w-100 mb-4">
                        <div class="col-12 col-md-6 col-xl-5">
                           <label for="NoIM1" class="form-label small-text2 col-12 mb-2 ms-2">How did you have the NoIM witnessed?</label>
                           <select name="NoIM1" id="NoIM1" class="js-placeholder-single-input form-control col-12">
                              <option value="" disabled="" selected="" hidden="">Select here</option>
                     ...
                     <div class="row w-100 mb-4">
                        <div class="col-12 col-md-6 col-xl-5 mb-4">
                           <label for="NoIM1" class="form-label small-text2 col-12 mb-2 ms-2">Authorised Person's Name who witnessed
                           Person 1 on the  NoIM</label>
                           <input type="text" placeholder="Type your witness' name here" class="form-control body-1 netural-100" name="name" id="InputName" required>
                        </div>
                        <div class="col-12 col-md-6 col-xl-5 mb-4">
                           <label for="NoIM1" class="form-label small-text2 col-12 mb-2 ms-2">Authorised Person's Name who witnessed
