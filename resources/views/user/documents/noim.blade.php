        ...
        <tbody>
            ...
            <tr>
                <td>
                    ...
                    <ul>
                        <li style="font-size: 12px; color: black; margin-bottom:8px;">Electronically by typing in the
                            required information directly into the boxes below. You can print and sign a hard copy of
                            the form or sign electronically in the presence of an authorised person.
                        </li>
                        <li style="font-size: 12px; color: black; margin-bottom: 8px">Manually by printing the form and
            ...
            <tr>
                <td>
                    ...
                    <ul>
                        <li style="font-size: 12px; color: black; margin-bottom:8px;">The Marriage Act 1961 (Cth) (the
                            Act) requires that a marriage shall not be solemnised unless certain personal information is
                            provided in writing. This information is required in two forms: the Notice of Intended
                            Marriage (under paragraph 42(1)(a) of the Act); and the Declaration of No Legal Impediment
                            to Marriage (under paragraph 42(1)(c) of the Act). Together with the Official Certificate of
                            Marriage (under paragraph 50(1)(b) of the Act), these three forms are referred to as the
                            Documents.
                        </li>
                        <li style="font-size: 12px; color: black; margin-bottom:8px">The Documents must be submitted by
                            the authorised celebrant to the Registrar of Births, Deaths and Marriages (the Registry) in
                        ...
                        <li style="font-size: 12px; color: black; margin-bottom:8px;"> The Registry uses the information
                            in the Documents to register the marriage. The Registry will use, store and disclose the
                            personal information in accordance with the privacy laws of the state or territory in which
                        ...
                        <li style="font-size: 12px; color: black; margin-bottom:8px;"> The Registry will provide the
                            ...
                            Bureau of Statistics (ABS), which requests the information under the Census and Statistics
                            Act 1905. The ABS only records non-identifying information from the Notice, and uses the
                            information to generate national statistics on marriage and the family in Australia. The ABS
                        ...
                        <li style="font-size: 12px; color: black; margin-bottom:8px;"> The Registry may provide the
                            Documents to the Registrar of Marriage Celebrants and the Commonwealth Attorney-General’s
                            Department for purposes related to the functions of the Registrar of Marriage Celebrants.
                    ...
                    <h2 style="font-weight: bold; font-size: 14px; color: black;">Instructions for completing this form
                    </h2>
                    <h3 style="font-weight: bold; font-size: 12px; color: black;">Requirements applying to ALL marrying
                        couples
                    </h3>
                    <p style="font-size: 12px; color: black;">It is a criminal offence for a person to give the Notice
                    ...
                    <p style="font-size: 12px; color: black;">You must give this completed and signed notice to an
                        ...
                        marriage, unless a prescribed authority has agreed to shorten the notice period (section 42 of
                        the Act). For a list of prescribed authorities, visit <a href="http://www.ag.gov.au/marriage"
                            target="_black" style="color:blue">www.ag.gov.au/marriage</a>.
                    </p>
                    ...
                    <p style="font-size: 12px; color: black;"><b>Where information is not known or cannot be
                            obtained:</b> If you are unable, after reasonable inquiry, to state any information required
                        ...
                        information. A statutory declaration is not required for items 11 to 16. These items relate to
                        the parents of the parties to the marriage. Complete this section where applicable.
                    </p>
                    <p style="font-size: 12px; color: black;"><b>Item 1:</b> It is up to each party to the marriage to
                    ...
                    <p style="font-size: 12px; color: black;"><b>Item 4:</b> This item is optional. It is up to each
                        party to the marriage to decide whether they wish to complete the item. It is up to each party
                        to the marriage to decide how they want to describe their gender if they choose to complete the
                        item. Non-binary includes ‘unspecified’ or ‘indeterminate’ and people who do not exclusively
                        identify as either female or male.
                    </p>
                    <p style="font-size: 12px; color: black;"><b>Item 7:</b> The term ‘conjugal status’ means whether
                        you have ever been legally married before. You should not include information about
                        relationships other than married relationships. If your status is ‘divorce pending’, the divorce
                    ...
                    <p style="font-size: 12px; color: black;"><b>Item 8: </b> If you were born <span
                            style="text-decoration:underline">in Australia</span> , your birthplace is the city or town
                        and state or territory. If you were born <span style="text-decoration: underline">outside
                            Australia</span>, your birthplace is the city or town, state or province (if applicable) and
                        country.
                    </p>
                    <p style="font-size: 12px; color: black;"><b>Item 1:</b> It is up to each party to the marriage to
                        decide how they want to describe themselves.
                    ...
                    <p style="font-size: 12px; color: black;">The Notice lists who can witness the signatures of the
                        marrying couple. The Notice must be signed in the physical presence of an authorised witness as
                        specified (section 42 of the Act). Authorised witnesses are listed in the “Signatures of parties
                        and witnesses” section of this form.
                    </p>
                    <p style="font-size: 12px; color: black;">If a person is unable to sign the Notice at the time it is
                        given to the authorised celebrant, the other person may sign the Notice and give it to the
                        authorised celebrant. The person who has not signed the Notice must then sign the Notice in the
                        physical presence of that celebrant or another authorised celebrant before the marriage can take
                        place.
                    </p>
                    <h3 style="font-weight: bold; font-size: 12px; color: black;">Documents that must be provided to an
                        authorised celebrant
                    </h3>
                    <p style="font-size: 12px; color: black;"><b>Items 19 to 20 and 25 to 28:</b> As well as the Notice,
                        before the marriage can take place both parties must provide to the authorised celebrant
                        (section 42 of the Act):
                    </p>
                    <ul style="list-style-type: lower-alpha;">
                        <li style="font-size: 12px; color: black; margin-bottom: 8px"> evidence of the parties’ date and
                            place of birth, such as a birth certificate, official extract from a birth register or an
                            Australian or overseas passport, and
                        </li>
                        <li style="font-size: 12px; color: black;">if a party is divorced or a party’s last spouse died,
                            evidence of divorce or death of that spouse.
                        </li>
                    </ul>
                    <p style="font-size: 12px; color: black;"><b>Items 21 to 24:</b>Before the marriage can take place,
                        ...
                        If numerous ID Documents are sighted by the celebrant and are more than can be accomodated at
                        Item 22, the celebrant may include details of the ID documents in an additional cover note to
                        the Registry.
                    </p>
                    <p style="font-size: 12px; color: black;"><b>Note: Items 25 to 28 </b>should only be completed for
                        parties who have been legally married previously. Where you have been legally married more than
                    ...
                    <h3 style="font-weight: bold; font-size: 12px; color: black;">Additional requirements apply when a
                        person to be married is under 18 years of age
                    </h3>
                    <p style="font-size: 12px; color: black;">A person under 18 years is not of marriageable age, and
                        cannot be a party to a marriage, unless the person obtains an order from a judge or magistrate
                        under section 12 of the Act.
                    </p>
                    <p style="font-size: 12px; color: black;">In addition, if you have not turned 18 (unless you have
                        previously been legally married), before the marriage can take place you must obtain and give to
                        the authorised celebrant the necessary consents or dispensations required under the Act.
                    </p>
                    <p style="font-size: 12px; color: black;">The authorised celebrant must record on the Notice that
                        they saw the court order and the consents or dispensations. The authorised celebrant may also
                    ...
                    <p style="font-size: 12px; color: black;">It is a criminal offence for a person to marry another
                        person who is under 18 years of age without the order of a judge or magistrate made before the
                        marriage (section 95 of the Act). Further, it is an offence under subsection 99(4) of the Act
                        for a marriage celebrant to solemnise a marriage involving a minor without receiving the
                        consents required under section 13 of the Act. Under no circumstances can two persons under 18
                        years legally marry.
                    </p>
                </td>
            </tr>
                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" height="100%"
                        ...
                        <tr>
                            <td>
                                ...
                                <p style="font-size: 12px; color: black;">Complete this form in <b>TYPE</b> or by using
                                    <b>BLOCK LETTERS</b>
                                </p>
                                <p
                            ...
                            <td>
                                <table align="left" border="0" cellpadding="0" cellspacing="10"
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 12px; color: black;">If applicable: Parent 2’s<br />full
                                            current name
                                            <br /><i>(or write ‘unknown’)</i>
                                        </td>
                                        <td style="font-size: 18px; color: black; font-weight: bold;">
                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" height="100%"
                        ...
                        <tr>
                            <td>
                                ...
                                <p style="font-size: 12px; color: black;">This Notice must be signed in the presence of
                                    an authorised witness. Persons who are authorised to witness the Notice are:
                                </p>
                                <ul>
                                    <li style="font-size: 12px; color: black; margin-bottom:8px;">if a party signs the
                                        Notice in Australia—an authorised celebrant, a justice of the peace, a barrister
                                    ...
                                    <li style="font-size: 12px; color: black; margin-bottom:8px;">if a party signs the
                                        ...
                                        Diplomatic Officer, a notary public, an employee of the Commonwealth authorised
                                        under paragraph 3(c) of the Consular Fees Act 1955, or an employee of the
                                        Australian Trade Commission authorised under paragraph 3(d) of the Consular Fees
                                        Act 1955.
                                ...
                                <p style="font-size: 12px; color: black;">I have read this form’s privacy notice and
                                            ...
                                            <table align="left" border="0" cellpadding="10" cellspacing="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-size: 12px; color: black;">Authority for
                                                        <br />marriage despite <br />late notice <br /><i>(shortening of
                                                            time)</i>
                                                    </td>
                                                    <td>
                                                        <div style="display: flex;">
