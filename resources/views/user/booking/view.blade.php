                  ...
                  <div class="row">
                     <div class="col-lg-4 mb-4 mb-lg-0">
                        <div class="location-grid">
                           <a href="http://simple-ceremonies.test/single-location/2" class="text-decoration-none">
                              <div class="card image-card">
                                 <img src="http://simple-ceremonies.test/uploads/images/locations/cronulla-1661515103.png" class="card-img-top" alt="location-1">                
                                 <div class="card-body pb-0">
                                    <div class="d-flex justify-content-between mb-15"> <span class="paragraph netural-100 align-self-center">$123</span> <span class=" align-self-center"><i class="fa-regular fa-heart heart"></i></span> </div>
                                    <h2 class="h3 netural-100 mb-0">manali</h2>
                                 </div>
                              </div>
                           </a>
                        </div>
                                    ...
                                    <div class="pseudo-item">
                                       <div class="location-search-grid">
                                          ...
                                          <div class="row">
                                             ...
                                             </div><div class="col-6 col-xl-4 mt-4">
                                                <a href="" class="time-and-price body-2">
                                                   <span class="netural-100 mb-1">09:00</span>
                                                   <span class="turquoise-100 mb-2">$ 350</span>
                                                   <span class="netural-100" style="font-size: 10px;">30 min</span>
