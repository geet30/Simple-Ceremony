...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td width="90%" align="left" valign="top">
            <font style="color:#df5555; font-size:24px"><strong style="font-weight:500"><em><span style="color:#464647"></span> New Booking: {{date('M d, Y',strtotime($data['booking_date']))}} at {{ucfirst($data['location_name'])}}. Fee ${{$total_fee}} </em></strong></font><br /><hr style=" border-color:#BFBFBF" /><br />
...
<p>Celebrant Fee  : ${{$price_your_fee}}</p><br>
<p>Admin Fee : ${{$price_admin_fee}}</p><br>
    </center>
