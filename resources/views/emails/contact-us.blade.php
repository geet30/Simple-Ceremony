<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td width="90%" align="left" valign="top">
            <font style="color:#df5555; font-size:24px"><strong style="font-weight:500"><em><span style="color:#464647"></span>Contact From <?php echo $data['first_name']; ?></em></strong></font><br /><hr style=" border-color:#BFBFBF" /><br />
            ...
            Phone Number - &nbsp;<?php echo '+'.$data['country_code'].$data['phone']; ?> <br>
            </font>
    <center>
