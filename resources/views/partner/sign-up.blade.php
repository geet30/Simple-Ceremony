                  ...
                  <div class="col-lg-12 col-xl-12 col-xxl-12">
                     <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                           ...
                           <input type="email" placeholder="Type your email here" class="form-control body-1 netural-100" name="user[email]" id="InputName" required>
                        ...
                        <div class="packageContainer">
                           <div class="row mt-2 packageDiv">
                              ...
                              <div class="col-md-6 mb-4">
                                 <div class="row">
                                    <div class="col-md-4">
                                       ...
                                       <input type="number" onkeydown="return event.keyCode !== 69" step="0.01" placeholder="$" class="form-control body-1 netural-100" name="partner_packages[0][partner_fee]" id="InputName" required>
                                    ...
                                    <div class="col-md-4">
                                       ...
                                       <input type="number" onkeydown="return event.keyCode !== 69" step="0.01" placeholder="$ 120" class="form-control body-1 netural-100" name="partner_packages[0][admin_fee]" id="InputName" required>
                                    ...
                                    <div class="col-md-4">
                                       ...
                                       <input type="number" onkeydown="return event.keyCode !== 69" step="0.01" placeholder="$ 120" class="form-control body-1 netural-100" name="partner_packages[0][total_fee]" id="InputName" required>
                              ...
                              <div class="col-md-3 mb-4">
                                 ...
                                 <input type="number" onkeydown="return event.keyCode !== 69" step="0.01" placeholder="%" class="form-control body-1 netural-100" name="partner_packages[0][deposit]" id="InputName">
                              </div>
                              <div class="col-md-3 mb-4">
                                 <label for="InputName" class="form-label small-text2">Simulation partner fee</label>
                                 <input type="number" onkeydown="return event.keyCode !== 69" step="0.01" placeholder="$" class="form-control body-1 netural-100" name="partner_packages[0][simulation_partner_fee]" id="InputName" required>
                              ...
                              <div class="col-md-3 mb-4">
                                 ...
                                 <div class="d-flex">
                                    <div class="input-error">
                                       <input type="number" onkeydown="return event.keyCode !== 69" step="0.01" placeholder="$" class="form-control body-1 netural-100" name="partner_packages[0][simulation_total_fee]" id="InputName" required>
                                       <div class="invalid-feedback"> <span><img class="me-2" src="/images/require-iocn.svg" alt="Require Icon"></span>Total fee is required</div>
                                    </div>
