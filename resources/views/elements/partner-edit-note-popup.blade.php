<div class="modal fade theme-modal" id="partner_edit_note" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="row">
               <div class="col-12">
                  <div class="d-flex justify-content-between align-items-start align-items-md-center flex-column flex-md-row">
                     <p class="body-3-regular neutral-100 mt-3 mt-md-0 order-2 mb-0 order-md-1">Created by</p>
                     <div class="order-1 mb-0 order-md-2">
                        <a type="button" class="me-3">
                        <img src="/images/admin/partner/trash.svg" alt="Delete" style="width:26px;">
                        </a>
                        <a type="button" class="theme-btn primary-btn me-3" data-bs-toggle="offcanvas" data-bs-target="#partner_note_edit_sidebar" aria-controls="offcanvasfeedbackaddons">Edit</a>
                        <a type="button" class="theme-btn primary-btn-border float-end" data-bs-dismiss="modal" aria-label="Close"> Close</a>
                     </div>
                  </div>
               </div>
               <div class="col-12">
                  <div class="d-flex mb-11 mt-4 mt-md-0">
                     <div  class="align-self-center"><img src="/images/avtar/nathan.png" class="rounded-circle theme-avtar"  alt="Created" /></div>
                     <div class="align-self-center body-2-semi-bold  neutral-100 ps-2">Tom & Jess - Couple</div>
                  </div>
               ...
               <div class="col-12 pt-30">
                  <div class="card card-turquoise-20">
                     <div class="card-body">
                        <div class="mb-60">
                           <h3 class="h4 neutral-100 mb-20">Additional info</h3>
