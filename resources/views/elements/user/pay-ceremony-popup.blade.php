<div class="modal whitout-header-modal fade" id="pay_ceremony_popup" tabindex="-1" aria-labelledby="exampleModalLabel"
aria-hidden="true">
      ...
      <div class="modal-body ">
         <div class="row mb-4">
            <div class="col-12 mb-3">
               <div class="d-flex">
                  <p class="h4  text-black align-self-center mb-0">Add title terms here</p>
               </div>
            </div>
            <div class="col-12 ">
               <p class="body-3-medium text-black mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
