<div class="offcanvas offcanvas-end theme-offcanvas" tabindex="-1" id="add"
   ...
   <div class="offcanvas-body">
      <form class="needs-validation" action="{{ route('list-to-do.store') }}" method="POST" novalidate>
         @csrf
         ...
         <div class="col-12 col-xl-10 mb-4">
            ...
            <textarea class="form-control body-1 netural-100" id="ceremonyplace" placeholder="Type here" name="description" rows="10" required></textarea>
         ...
         <div class="col-12 col-xl-10  mb-4 event_date">
            ...
            <div class="input-group date theme-datepicker">
               <input role="button" type="text" class="form-control body-1 netural-100 event_date_input" id="event_date" name="due_date"  placeholder="Choose due date here" required/>
         ...
         <div class="d-lg-flex mt-5">
            <button type="submit" class="theme-btn primary-btn me-lg-3 d-flex justify-content-center mb-3 mb-lg-0">Create</button>
