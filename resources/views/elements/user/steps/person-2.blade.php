<div class="row">
   <div class="col-12">
      <div class="d-md-flex w-100">
         <div class="d-flex add-ons-detail ">
            ...
            <h2 class="subheader-3 neutral-100 align-self-center mb-0 ms-2">Packages 2</h2>
         </div>
         <div class="ms-md-5 mt-3 mt-md-0 w-md-25">
            <label for="InputName" class="form-label small-text2">Person 2 Preferred name</label>
            <input type="text" value="Ava" class="form-control body-1 netural-100" name="name" id="InputName" required>
   ...
   <div class="col-12 mt-4">
      <div class="card card-turquoise-noim">
         <div class="card-body ">
            <h3 class="h4 text-black mb-3 text-center">Upload govt issued photo ID and evidence of date and place of birth</h3>
            <p class="body-3-medium neutral-100 col-xl-10 mx-auto text-center">After uploading your data, the form below will be automatically filled, please make sure to double-check your data!</p>
            <div class="col-xl-10 mx-auto text-center">
               <div class="haze-alert  body-3-medium ">If you are uploading your passport, there is no need to upload Govt issued photo ID as well (eg Drivers Licence)</div>
            </div>
            <div class="col-xl-10 mx-auto mt-20">
               <div class="row">
                  <div class="col-md-6 mb-4 align-self-end">
                     <label for="birth" class="form-label small-text2">What evidence of Date and Place of Birth are you using?</label>
                  ...
                  <div class="col-md-6 mb-4 align-self-end">
                     ...
                     <select name="id" id="id" class="js-placeholder-single-input form-control">
                        <option value="" disabled="" selected="" hidden="">Select answer here</option>
   ...
   <div class="col-12 mt-4">
      <div class="row">
         ...
         <div class="col-md-12 mb-4 align-self-top">
            ...
            <input type="text" value="Geoff George SMITH" class="form-control body-1 netural-100" name="name" id="description" required>
         </div>
         ...
         <div class="col-md-6 mb-4 ">
            ...
            <input type="text" value="-" class="form-control body-1 netural-100" name="name" id="description" required>
         </div>
         <div class="col-md-6 mb-4 ">
         ...
         <div class="col-md-6 mb-4 ">
            ...
            <input type="text" value="0000" class="form-control body-1 netural-100" name="name" id="description" required>
         </div>
         <div class="col-md-6 mb-4 align-self-top">
         ...
         <div class="col-md-6 mb-4 ">
            ...
            <input type="text" value="09/03/1995" class="form-control body-1 netural-100" name="name" id="description" required>
         </div>
