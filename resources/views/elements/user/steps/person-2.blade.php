    ...
    <div class="col-12">
        <div class="d-md-flex w-100">
            ...
            <div class="ms-md-5 mt-3 mt-md-0 w-md-25">
                ...
                <input type="text" value="Ava" class="form-control body-1 netural-100" name="name"
    ...
    <div class="col-12 mt-4">
        <div class="row">
            ...
            <div class="col-md-6 mb-4 align-self-top">
                ...
                <input type="text" value="Maria" class="form-control body-1 netural-100" name="name"
                    id="description" required>
            </div>
            <div class="col-md-6 mb-4 align-self-top">
                <label for="description" class="form-label small-text2">Other given name(s)</label>
                <input type="text" value="Natalie" class="form-control body-1 netural-100" name="name"
                    id="description" required>
            </div>
            ...
            <div class="col-12 mb-4">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="remember4" id="remember4"
                        autocomplete="off">
            ...
            <div class="col-md-6 mb-4 align-self-top">
                ...
                <input type="text" value="Accountant" class="form-control body-1 netural-100" name="name"
                    id="description" required>
            </div>
            <div class="col-md-6 mb-4 align-self-top">
            ...
            <div class="col-md-6 mb-4 ">
                ...
                <input type="text" value="21 Ramsey street" class="form-control body-1 netural-100"
                    name="name" id="description" required>
            </div>
            <div class="col-md-6 mb-4 ">
            ...
            <div class="col-md-6 mb-4 ">
                ...
                <input type="text" value="Erinsburgh" class="form-control body-1 netural-100" name="name"
                    id="description" required>
            </div>
            <div class="col-md-6 mb-4 align-self-top">
            ...
            <div class="col-12 ">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="remember7" id="remember7"
                        autocomplete="off">
