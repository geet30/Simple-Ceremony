    ...
    <div class="col-12 ">
        <div class="row">
            <div class="col-md-6 mb-4">
                <label for="description" class="form-label small-text2">Family name</label>
        ...
        <div class="row">
            <div class="col-md-6 mb-4 align-self-top">
                <label for="description" class="form-label small-text2">First name</label>
                <input type="text" value="Tony" class="form-control body-1 netural-100" name="name"
                    id="description" required>
            </div>
            <div class="col-md-6 mb-4 align-self-top">
                <label for="description" class="form-label small-text2">Last/other name</label>
                <input type="text" value="MAX" class="form-control body-1 netural-100" name="name"
                    id="description" required>
            </div>
        </div>
    </div>
...
<div class="row mt-3">
    ...
    <div class="col-12 ">
        <div class="row">
            <div class="col-md-6 mb-4">
                <label for="description" class="form-label small-text2">Family name</label>
                <input type="text" value="Rodge" class="form-control body-1 netural-100" name="name"
                    id="description" required>
                <span class="small-text2 text-black mt-1">*Must be in UPPERCASE</span>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 mb-4 align-self-top">
                <label for="description" class="form-label small-text2">First name</label>
                <input type="text" value="Alex" class="form-control body-1 netural-100" name="name"
                    id="description" required>
            </div>
            <div class="col-md-6 mb-4 align-self-top">
                <label for="description" class="form-label small-text2">Last/other name</label>
                <input type="text" value="TOBEY" class="form-control body-1 netural-100" name="name"
                    id="description" required>
            </div>
        </div>
    </div>
    <div class="col-12 mb-4">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="witness" id="witness" autocomplete="off">
