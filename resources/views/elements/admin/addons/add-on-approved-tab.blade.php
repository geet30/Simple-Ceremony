<div class="table-responsive">
    <table class="table align-middle theme-table">
        ...
        <tbody id="add-on-approved-tab_searchList">
            <?php $count = 0;?>
            ...
            <tr>
                ...
                <div class="dropdown table-dropdown">
                    <button class="btn dropdown-toggle {{$status_class}}" type="button" 
                     id="add-on-approved-tab_{{$addon->id}}" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <tfoot>
            <tr>
                <td colspan="6">
                <?php $data = array();?>
                    @include('elements.admin.addons.pagination',array('data'=>$approved_addons))
