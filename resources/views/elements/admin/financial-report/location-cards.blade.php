        ...
        <div class="nav-link">
            <div class="add-ons-nav d-flex">
                ...
                <div class="add-ons-nav-data text-start ">
                    <h3 class="h3"> ${{ number_format(locationTotalRevenue($data),2)}}</h3>
    ...
    <li class="col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3">
        <div class="nav-link">
            <div class="add-ons-nav d-flex">
                ...
                <div class="add-ons-nav-data text-start ">
                    <h3 class="h3">${{ number_format(locationTotalCofgs($data),2)}}</h3>
    ...
    <li class="col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3">
        <div class="nav-link">
            <div class="add-ons-nav d-flex">
                ...
                <div class="add-ons-nav-data text-start ">
                    <h3 class="h3">${{ number_format(locationTotalMargin($data),2)}}</h3>
