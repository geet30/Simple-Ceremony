<div class="offcanvas offcanvas-end theme-offcanvas partner-module-sidebar" tabindex="-1" id="marriage-celebrant"
    ...
    <div class="offcanvas-body">
        <form method="post" id="add-celebrants" action="{{ route('save-celebrant') }}" name="postform">
            ...
            <div class="col-md-10 col-xl-6 mb-4">
                ...
                <select required="" id="celebrant_id" name="celebrant_id"
                ...
                <div class="invalid-feedback"> <span><img class="me-2" src="/images/require-iocn.svg"
                            alt="Require Icon"></span>Marriage couple is required</div>
            </div>
            <div class="col-12">
