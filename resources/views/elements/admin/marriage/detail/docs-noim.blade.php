        ...
        <form method="POST">
            ...
            <div class="row">
                <div class="col-md-12   mb-4">
                    ...
                    <input type="text"
                        value="{{ isset($couple1->person_name_combination) ? $couple1->person_name_combination : '' }}"
                        class="form-control body-1 netural-100" name="name" id="preferredname2" readonly>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6  mb-4 ">
                    ...
                    <input type="text" value="{{ isset($couple1->date_of_birth) ? $couple1->date_of_birth : '' }}"
                        class="form-control body-1 netural-100" name="name" id="preferredname2" readonly>
                </div>
            ...
            <div class="row">
                <div class="col-md-4  mb-4 ">
                    ...
                    <input type="text" value="{{ isset($couple1->birth_place) ? $couple1->birth_place : '' }}"
                        class="form-control body-1 netural-100" name="name" id="preferredname2" readonly>
                </div>
                <div class="col-md-4  mb-4 ">
                    <label for="preferredname2" class="form-label small-text2 ps-2">Suburb/town/city</label>
                    <input type="text"
                        value="{{ isset($couple1->residence_town_or_city_or_suburb) ? $couple1->residence_town_or_city_or_suburb : '' }}"
                        class="form-control body-1 netural-100" name="name" id="preferredname2" readonly>
                </div>
                <div class="col-md-4  mb-4 ">
                    <label for="preferredname2" class="form-label small-text2 ps-2">State/territory</label>
                    <input type="text"
                        value="{{ isset($couple1->residence_state_or_province_or_territory) ? $couple1->residence_state_or_province_or_territory : '' }}"
                        class="form-control body-1 netural-100" name="name" id="preferredname2" readonly>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-7 col-xl-8 align-self-center">
                                    ...
                                    @if (isset($couple1->birthDocument) && !empty($couple1->birthDocument))
                                        <embed
                                            src="{{ asset('uploads/documents/user/' . $couple1->birthDocument->document_path) }}"
                                            class="img-fluid" alt="id-1">
                                    @endif
                                </div>
                                <div class="col-md-5 col-xl-4 align-self-center">
                                    <p class="h4 neutral-100">ID Person 1</p>
                                    <p class="h3 neutral-100">
                                        {{ isset($couple1->preferred_name) ? $couple1->preferred_name : '' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12   mb-4">
                    ...
                    <input type="text"
                        value="{{ isset($couple2->person_name_combination) ? $couple2->person_name_combination : '' }}"
                        class="form-control body-1 netural-100" name="name" id="preferredname2" readonly>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6  mb-4 ">
                    <label for="preferredname2" class="form-label small-text2 ps-2">Date of Birth</label>
                    <input type="text" value="{{ isset($couple2->date_of_birth) ? $couple2->date_of_birth : '' }}"
                        class="form-control body-1 netural-100" name="name" id="preferredname2" readonly>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4  mb-4 ">
                    <label for="preferredname2" class="form-label small-text2 ps-2">Suburb/town/city</label>
                    <input type="text"
                        value="{{ isset($couple2->residence_town_or_city_or_suburb) ? $couple2->residence_town_or_city_or_suburb : '' }}"
                        class="form-control body-1 netural-100" name="name" id="preferredname2" readonly>
                </div>
                <div class="col-md-4  mb-4 ">
                    <label for="preferredname2" class="form-label small-text2 ps-2">State/territory</label>
                    <input type="text"
                        value="{{ isset($couple2->residence_state_or_province_or_territory) ? $couple2->residence_state_or_province_or_territory : '' }}"
                        class="form-control body-1 netural-100" name="name" id="preferredname2" readonly>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-7 col-xl-8 align-self-center">
                                    @if (isset($couple2->birthDocument) && !empty($couple2->birthDocument))
                                        <embed
                                            src="{{ asset('uploads/documents/user/' . $couple2->birthDocument->document_path) }}"
                                            class="img-fluid" alt="id-1">
                                    @endif
                                </div>
                                <div class="col-md-5 col-xl-4 align-self-center">
                                    ...
                                    <p class="h3 neutral-100">
                                        {{ isset($couple2->preferred_name) ? $couple2->preferred_name : '' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="row pt-52 ">
    <div class="pe-xl-0 col-xl-12 mb-4 mb-xl-0">
        <div class="d-flex add-ons-detail">
            ...
            <h2 class="h4 neutral-100 align-self-center mb-2 ms-2">Who witnessed the signed Notice of Intended Marriage
                form</h2>
        </div>
    </div>
    <div class=" col-xl-10 offset-xl-2 mt-3 mt-md-0">
        <div class="row">
            <div class="col-md-6 mb-4">
                <label for="preferredname2" class="form-label small-text2 ps-2">How do you have the NOIM
                    witness</label>
                @php
                    $arr = [1 => 'Live video', 2 => 'Video recording', 3 => 'In person'];
                @endphp
                <input type="text"
                    value="{{ $couple1 && $couple1->marriageDocument ? $arr[$couple1->marriageDocument->how_did_you_have_noim_witnessed] : '' }}"
            ...
            <div class="col-md-6 mb-4">
                ...
                <input type="text"
                    value="{{ $couple1 && $couple1->marriageDocument ? $couple1->marriageDocument->authorization_code : '' }}"
                    class="form-control body-1 netural-100" name="name" id="preferredname2">
            </div>
        </div>
        @php
        ...
        <div class="row align-items-baseline">
            <div class="col-md-6 mb-4">
                <label for="preferredname2" class="form-label small-text2 ps-2">Who has witnessed Person 1 sign the
                    NOIM</label>
                    <?php $who_signed_person_1_witness = '';
                    if(isset($couple1->marriageDocument) && !empty($couple1->marriageDocument->who_signed_person_1_witness)){
                        $who_signed_person_2_witness = $witnessArr[$couple1->marriageDocument->who_signed_person_1_witness];
                    }
        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                <label for="preferredname2" class="form-label small-text2 ps-2">Who has witnessed Person 2 sign the
                    NOIM</label>
                    <?php $who_signed_person_2_witness = '';
                    if(isset($couple1->marriageDocument) && !empty($couple1->marriageDocument->who_signed_person_2_witness)){
                        $who_signed_person_2_witness = $witnessArr[$couple1->marriageDocument->who_signed_person_2_witness];
                    }
        ...
        <div class="row align-items-baseline">
            <div class="col-md-6 mb-4">
                ...
                <?php $person_1_witness_occupation_name = '';
                    if(isset($couple1->marriageDocument) && !empty($couple1->marriageDocument->person_1_witness_occupation_name)){
                        $who_signed_person_2_witness = $couple1->marriageDocument->person_1_witness_occupation_name;
                    }
            ...
            <div class="col-md-6 mb-4">
                ...
                <?php $person_2_witness_name = '';
                    if(isset($couple1->marriageDocument) && !empty($couple1->marriageDocument->person_2_witness_name)){
                        $who_signed_person_2_witness = $couple1->marriageDocument->person_2_witness_name;
                    }
                ...
                <div class="card doument-box">
                    <div class="card-body text-center">
                        ...
                        <p class="mb-10"> <a class="theme-btn primary-btn-border  cursor-pointer d-inline-flex"
                                href="{{ route('admin.userNoim.preview-document', ['page' => 'noim-perview', 'id' => $couple1 ? $couple1->user_id : '']) }}">View</a>
                        </p>
                        ...
                        <p class="mb-0"> <a class="theme-btn primary-btn   cursor-pointer d-inline-flex"
                                href="{{ route('admin.userNoim.preview-document', ['page' => 'noim-download', 'id' => $couple1 ? $couple1->user_id : '']) }}">Download</a>
                        </p>
                    </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card doument-box">
                    <div class="card-body text-center">
                        ...
                        <p class="mb-10"> <a class="theme-btn primary-btn-border  cursor-pointer d-inline-flex"
                                href="{{ route('admin.userNoim.preview-document', ['page' => 'preview-official-certificate-of-marriage', 'id' => $couple1 ? $couple1->user_id : '']) }}">View</a>
                        </p>
                        <p class="mb-0"> <a class="theme-btn primary-btn   cursor-pointer d-inline-flex"
                                href="{{ route('admin.userNoim.preview-document', ['page' => 'download-official-certificate-of-marriage', 'id' => $couple1 ? $couple1->user_id : '']) }}">Download</a>
                        </p>
                    </div>
                    <div class="card-footer  text-center">
                        <p class="small-text-3 gray-500 mb-0">Created Feb 29, 2022</p>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card doument-box">
                    <div class="card-body text-center">
                        ...
                        <p class="mb-10"> <a class="theme-btn primary-btn-border  cursor-pointer d-inline-flex"
                                href="{{ route('admin.userNoim.preview-document', ['page' => 'preview-declaration-of-no-legal-impediment-to-marriage', 'id' => $couple1 ? $couple1->user_id : '']) }}">View</a>
                        </p>
                        <p class="mb-0"> <a class="theme-btn primary-btn   cursor-pointer d-inline-flex"
                                href="{{ route('admin.userNoim.preview-document', ['page' => 'download-declaration-of-no-legal-impediment-to-marriage', 'id' => $couple1 ? $couple1->user_id : '']) }}">Download</a>
                        </p>
                    </div>
                    <div class="card-footer  text-center">
                        <p class="small-text-3 gray-500 mb-0">Created Feb 29, 2022</p>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card doument-box">
                    <div class="card-body text-center">
                        ...
                        <p class="mb-10"> <a class="theme-btn primary-btn-border  cursor-pointer d-inline-flex"
                                href="{{ route('admin.userNoim.preview-document', ['page' => 'preview-certificate-of-marriage', 'id' => $couple1 ? $couple1->user_id : '']) }}">View</a>
                        </p>
                        <p class="mb-0"> <a class="theme-btn primary-btn   cursor-pointer d-inline-flex"
                                href="{{ route('admin.userNoim.preview-document', ['page' => 'download-certificate-of-marriage', 'id' => $couple1 ? $couple1->user_id : '']) }}">Download</a>
                        </p>
                    </div>
                    <div class="card-footer  text-center">
                        <p class="small-text-3 gray-500 mb-0">Created Feb 29, 2022</p>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card doument-box">
                    <div class="card-body text-center">
                        ...
                        <p class="mb-10"> <a class="theme-btn primary-btn-border  cursor-pointer d-inline-flex"
                                href="{{ route('admin.userNoim.preview-document', ['page' => 'preview-certificate-of-faithful-performance-by-interpreter', 'id' => $couple1 ? $couple1->user_id : '']) }}">View</a>
                        </p>
                        <p class="mb-0"> <a class="theme-btn primary-btn   cursor-pointer d-inline-flex"
                                href="{{ route('admin.userNoim.preview-document', ['page' => 'download-certificate-of-faithful-performance-by-interpreter', 'id' => $couple1 ? $couple1->user_id : '']) }}">Download</a>
                        </p>
                    </div>
                    <div class="card-footer  text-center">
                        <p class="small-text-3 gray-500 mb-0">Created Feb 29, 2022</p>
    ...
    <div class=" col-xl-8 offset-xl-2 mt-3 mt-md-0">
        <div class="row mb-2">
            <div class=" col-lg-12 mt-3 mt-md-0">
                <div class="align-self-center me-2 mb-4 body-2-semi-bold"><span
                ...
                <div class="d-lg-flex">
                    <form method="POST" name="booking_details" id="booking_details"
                        action="{{ route('celebrant.saveRecord') }}">
                        <?php

                        if (isset($data->booking_details->checked) && $data->booking_details->checked == 1) {
                            $buttonClass = '';
                            $checked = 'checked';
                            $button_text = 'All details correct';
                        } else {
                            $buttonClass = 'bg-danger';
                            $checked = '';
                            $button_text = 'have you confirm all details are correct ?';
                        }
                        ?>
                        @csrf
                        ...
                        <input class="form-check-input me-2" type="checkbox" name="checked" value="1"
                            {{ $checked }}
                            onchange="submitAjaxWithoutReload(event, 'booking_details', 'post', '/saveRecord')">
                        <a
                            class="changeButton theme-btn primary-btn {{ $buttonClass }} cursor-pointer d-inline-flex me-lg-3 mb-4 mb-lg-0">{{ $button_text }}</a>
                    </form>
                    <a class="theme-btn primary-btn-border  cursor-pointer d-inline-flex" data-bs-toggle="offcanvas"
                        data-bs-target="#feedback" aria-controls="feedback">Give feedback</a>
                </div>
            </div>
