         ...
         <div class="modal-body">
            <div class="row">
               ...
               <div class="col-lg-6 order-lg-1">
                  <p class="body-3-regular neutral-100 mb-0">Created by </p>
                  <div class="d-flex mb-11 mt-3">
               ...
               <div class="col-12 pt-30 order-lg-3">
                  <div class="card card-turquoise-20">
                     <div class="card-body">
                        ...
                        <p class="body-3-medium text-black">Empty </p>
                        <!-- <div class="pdf-downlaod">
                           <img src="/images/attach-file.jpg" class="img-fluid" alt="attach-file">
                           <div class="overlay">
                              <div class="text"><img src="/images/download-icon.svg" alt=""></div>
                           </div>
                        </div> -->
                     </div>
                  </div>
               </div>
               <div class="col-lg-6 d-flex justify-content-end order-lg-2 mt-3 mt-lg-0"> 
               <div class="align-self-center me-3"><a  type="button" data-bs-dismiss="modal" aria-label="Close" ><img src="/images/icons/delete.svg" class="img-fluid" alt="delete"/></a> </div>
                  <div class="align-self-center me-3">
                  <a href="" class="theme-btn primary-btn "  data-bs-toggle="offcanvas" data-bs-target="#edit-note">Edit</a>
                   </div>
                  <div class="align-self-center"><a  type="button" class="theme-btn primary-btn-border " data-bs-dismiss="modal" aria-label="Close"> Close</a></div>
               </div>
            </div>
         </div>
      </div>
