                  ...
                  <table class="table align-middle theme-table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="body-2 neutral-100">Tench park</td>
                           <td  class="body-2 neutral-100" >Thiruvananthapuram</td>
                        ...
                        <tr>
                           ...
                           <td class="body-2 neutral-100">Hunter Bay</td>
                           <td  class="body-2 neutral-100" >Loremipsumdolor</td>
                        ...
                        <tr>
                           ...
                           <td class="body-2 neutral-100">Bondi beach</td>
                           <td  class="body-2 neutral-100" >Loremipsumdolor</td>
                        ...
                        <tr>
                           ...
                           <td class="body-2 neutral-100">Bradfield park</td>
                           <td  class="body-2 neutral-100" >Loremipsumdolor</td>
                           <td  class="body-2 neutral-100">09090</td>
                        ...
                        <tr>
                           ...
                           <td  style="min-width:200px" class="body-2 neutral-100">Hunter Valley</td>
                           <td  class="body-2 neutral-100" >Loremipsumdolor</td>
                           <td  class="body-2 neutral-100">09090</td>
                           <td  style="min-width:300px" class="body-2 neutral-100">Blues Point Rd, North Sydney NSW 2060, Australia</td>
                            <td  style="min-width:100px"><a class="table-link button-1"> <a class="btn edit-btn "  href="">Confirm</a></td>
                        ...
                        <tr>
                           ...
                           <td  style="min-width:200px" class="body-2 neutral-100">Baulkham Hills</td>
                           <td  class="body-2 neutral-100" >Loremipsumdolor</td>
                           <td  class="body-2 neutral-100">09090</td>
                        ...
                        <tr>
                           ...
                           <td  style="min-width:200px" class="body-2 neutral-100">Little Vintage</td>
                           <td  class="body-2 neutral-100" >Loremipsumdolor</td>
                           <td  class="body-2 neutral-100">09090</td>
                        ...
                        <tr>
                           ...
                           <td  style="min-width:200px" class="body-2 neutral-100">Merewether</td>
                           <td  class="body-2 neutral-100" >Loremipsumdolor</td>
                           <td  class="body-2 neutral-100">09090</td>
                           <td  style="min-width:300px" class="body-2 neutral-100">Blues Point Rd, North Sydney NSW 2060, Australia</td>
                            <td  style="min-width:100px"><a class="table-link button-1"> <a class="btn edit-btn "  href="">Confirm</a></td>
                           <td  style="min-width:150px"><a class="table-link button-1"  href=""> View info</a> </td>
                        </tr>
                        <tr>
                           <td style="min-width:150px" class="body-2 neutral-100">Dianne Russell</td>
                           <td  style="min-width:200px" class="body-2 neutral-100">Hermannsburg</td>
                           <td  class="body-2 neutral-100" >Loremipsumdolor</td>
                           <td  class="body-2 neutral-100">09090</td>
