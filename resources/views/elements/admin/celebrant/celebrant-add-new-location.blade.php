<div class="offcanvas offcanvas-end theme-offcanvas" tabindex="-1" id="celebrant_addlocation" aria-labelledby="offcanvasRightLabel">
  ...
  <div class="offcanvas-body">
    <div class="col-md-9 mb-4">
      ...
      <input type="text" placeholder="Type your location name here" class="form-control body-1 netural-100" name="name" id="InputName">
    </div>
