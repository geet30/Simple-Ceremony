...
<nav class="navbar sticky-top navbar-expand-lg theme-navbar navbar-light ">
    <div class="container">
      ...
      <div class="d-flex mobile-toogle-with-cart align-items-center">
        <a class="nav-item nav-link align-self-lg-center cart-icon-header d-block d-lg-none position-relative me-3 show-addon-basket-header" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
        ...
        <div class="navbar-nav ">
          ...
          <a class="nav-item nav-link align-self-lg-center cart-icon-header d-none d-lg-block me-lg-4 position-relative show-addon-basket-header" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
            <img src="{{asset('/images/cart-icon.svg')}}" lass="img-fluid" alt="Cart Icon">
            <span class="cart-item-counting">{{$cart_count }}</span>
          </a>
          <a href="{{route('user.booking')}}" class="theme-btn primary-btn w-full w-lg-auto me-lg-4 mb-3 mb-lg-0">Make a booking</a>
