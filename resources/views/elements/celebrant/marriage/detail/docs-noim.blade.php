   ...
   <div class=" col-xl-7 mb-3 mb-xl-0">
      <form  method="POST" >
         ...
         <div class="row">
            ...
            <div class="col-md-6  mb-4 ">
               <label for="preferredname2" class="form-label small-text2 ps-2">Person 1 last name</label>
         ...
         <div class="row">
            ...
            <div class="col-md-6  mb-4 ">
               <label for="preferredname2" class="form-label small-text2 ps-2">Person 2 last name</label>
         ...
         <div class="row">
            <div class="col-md-6  mb-4 ">
               <label for="preferredname2" class="form-label small-text2 ps-2">Date of Birth</label>
               <input type="text" value="01/09/1996" class="form-control body-1 netural-100" name="name" id="preferredname2">
            </div>
            <div class="col-md-6  mb-4 ">
               <label for="preferredname2" class="form-label small-text2 ps-2">Birth place</label>
               <input type="text" value="Australia" class="form-control body-1 netural-100" name="name" id="preferredname2">
               ...
               <div class="border-turquoise-50 bg-turquoise-20 p-3 br-10">
                  <div class="id-card border-turquoise-50 br-10">
                     <div class="row">
                        ...
                        <div class="col-md-5 col-xl-4 align-self-center">
                           <p class="h4 neutral-100">ID Person 2</p>
...
<div class="pe-xl-0 col-xl-2 mb-4 mb-xl-0">
   ...
   <div class=" col-lg-10 mt-3 mt-md-0">
      ...
      <a class="theme-btn primary-btn   cursor-pointer d-inline-flex me-lg-3 mb-4 mb-lg-0">Confirm that the NoIM data is complete</a>
