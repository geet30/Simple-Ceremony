                              ...
                              <table style="width:100%" cellpadding="18">
                                 ...
                                 <tbody>
                                    <tr style="border-bottom:1px solid #62CBC9;">
                                       ...
                                       <td style="min-width:400px;font-weight: 400;font-size: 12px;line-height: 20px; color: #1C1C1C;">Ceremony Fee for 2/3/2022 - John & Mary</td>
                                       <td style="min-width:100px;font-weight: 400;font-size: 12px;line-height: 20px; color: #1C1C1C;text-align: right;">$110</td>
                                    </tr>
                                    <tr style="background: #F7FCFC; border-bottom:1px solid #62CBC9;">
                                       ...
                                       <td  style="min-width:100px;font-weight: 400;font-size: 12px;line-height: 20px; color: #1C1C1C;">Ceremony Fee for 4/3/2022 - Dave & John</td>
                                       <td  style="min-width:100px;font-weight: 400;font-size: 12px;line-height: 20px; color: #1C1C1C;text-align: right;">$110</td>
                                    </tr>
                                 </tbody>
                                 <tfoot>
                                    <tr>
                                       ...
                                       <td  style="min-width:100px;font-weight: 700;font-size: 12px;line-height: 20px; color: #1C1C1C;text-align: right;">$ 220</td>
                                    </tr>
                                 </tfoot>
                              </table>
                           </td>
