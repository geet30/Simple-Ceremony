<div class="modal-success-form modal fade cancel-ceremony-popup" id="delete_celebrant_location" tabindex="-1"
      aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              <form method="post" class="delete_form" action="{{ url('/all-locations',0) }}">
                  @method('DELETE')
                  @csrf
