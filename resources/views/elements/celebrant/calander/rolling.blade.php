                        ...
                        <div class="card  panel-card h-100">
                           <div class="card-body">
                              ...
                              <div class="col-md-12 mb-4">
                                 ...
                                 <select name="choose-date" id="choose-date" class="js-placeholder-single-input form-control">
                              ...
                              <div class="col-md-12 mb-4">
                                 ...
                                 <select name="end-date" id="end-date" class="js-placeholder-single-input form-control">
                                    <option value="" disabled="" selected="" hidden="">Choose date</option>
                              ...
                              <div class="col-12 d-md-flex">
                                 <a class="theme-btn primary-btn d-flex justify-content-center me-md-2 mb-3 mb-md-0">Apply</a>
                                    ...
                                    <table class="table align-middle calander-table">
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td class="h4 dark-blue-100">SUN</td>
