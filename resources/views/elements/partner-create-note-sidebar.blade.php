<div class="offcanvas offcanvas-end theme-offcanvas partner-module-sidebar" tabindex="-1" id="partner_create_note_sidebar" aria-labelledby="offcanvasRightLabel">
  <div class="offcanvas-header">
    <p id="offcanvasRightLabel" class="h3 neutral-100">Create note</p>
  ...
  <div class="offcanvas-body">
    <form>
      ...
      <div class="col-12">
        <button type="submit" id="submit_button" class="theme-btn primary-btn border-0">Create</button>
      </div>
   </form>
  </div>
</div>