  ...
  <div class="row m-0">
     <div class="col-md-12 col-lg-8 booking-custom-location align-self-center">
      <div class="booking-process-bar d-flex align-items-center">
        <span class="h4 mb-0 turquoise-100 me-3">Booking progress</span>
        ...
        <div class="booking-info ms-3">
          ...
          <div class="booking-info-details">
            ...
            <a href="#" class="user-dash-links turquoise-100 d-inline-block mt-3">Click here here to set up NoIM</a>
          </div>
        </div>
      </div>
     </div>
                ...
                <li class="nav-item dropdown align-self-center me-3 user-header-login">
                 ...
                 <li class="nav-item dropdown align-self-center">
                    ...
                    <ul class="dropdown-menu  admin-profile-menu" aria-labelledby="navbarScrollingDropdown">
                       <li><a class="dropdown-item" href="/user/account-details"><img src="/images/icons/team.svg" class="img-fluid">Setting Profile</a></li>
                       <li><a class="dropdown-item logout" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> <img src="/images/icons/logout.svg" class="img-fluid">Log out</a></li>
