                  ...
                  <tbody>
                     <tr>
                        <td
                           ...
                           {{config('ceremonyStatus.typeOfCeremony.'.$data->booking->ceremony_type) }}</td>
                        <td
                           style="font-weight: 400;font-size: 12px;line-height: 20px;color: #1C1C1C;font-family: 'Montserrat', sans-serif;padding: 15px 20px;text-align: left;">
                           {{date('M d, Y',strtotime($data->booking->booking_date))}}</td>
                        <td
                           ...
                           {{$data->booking->first_couple_name}}  &  {{$data->booking->second_couple_name}}</td>
                     </tr>
                     <tr>
