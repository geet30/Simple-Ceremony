   ...
   <div class="container">
      <div class="row">
         <div class="col-md-12 mt-5 mb-5">
            <a href="/voucher" class="theme-btn secondary-btn d-inline-flex back-btn"><img class="me-3" src="/images/single-location/left-icon.svg" alt="Back Icon">Back</a>
            </div>
            ...
            <div class="row align-items-center">
               <div class="col-md-6">
                  ...
                  <a href="#" class="theme-btn primary-btn d-inline-flex mt-4">
                     <img class="me-3" src="/images/voucher/white-cart-icon.svg" alt="Back Icon">Add to cart
                  </a>
               </div>
               <div class="col-md-5 offset-md-1">
                  <img class="img-fluid w-100" src="images/voucher/voucher-single.png" alt="Voucher Image">
               </div>
            </div>
         </div>
         <div class="col-md-12">
            <h2 class="pb-20 mt-2 h3 netural-100">Other Gift Certificate</h2>
         </div>
