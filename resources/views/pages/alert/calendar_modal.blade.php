<div class="modal-success-form modal fade cancel-ceremony-popup" id="show_calendar_data_modal" tabindex="-1"
      aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">             
            <form method="post" id="status_change" onsubmit="return submitThroughAjax(event,'status_change','post','/change-booking-status')">
                  @csrf
