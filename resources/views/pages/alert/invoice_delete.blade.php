<div class="modal-success-form modal fade cancel-ceremony-popup" id="delete_alert" tabindex="-1"
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              <form method="post" class="delete_form"  id="delete_celebrant" action="{{ route('payments.destroy', 1) }}">
                  @method('DELETE')
                  @csrf
                  <input type="hidden" name="id">
                  <div class="modal-body text-center">
                      <img class="mt-4" src="/images/user/exclamation.svg" alt="Exclamation">
                      <h4 class="h4 netural-100 mb-4 mt-4">Are you sure you want to delete the invoice?
                      </h4>
