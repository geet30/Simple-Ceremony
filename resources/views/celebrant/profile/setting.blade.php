                     ...
                     <form class="needs-validation" method="POST" novalidate>
                        <div class="row">
                           ...
                           <div class="col-md-6 mb-4">
                              <div class="row">
                                 <div class="col-12">
                                    <label for="InputName" class="form-label body-2">Locations list</label>
                                 </div>
                                 <div class="col-12 mb-4">
                                    <input type="text" value="Bradfield park" class="form-control body-1 netural-100" name="name" id="InputName" required>
                                    <div class="invalid-feedback"> <span><img class="me-2" src="/images/require-iocn.svg" alt="Require Icon"></span>Contact name is required</div>
                                 </div>
                                 <div class="col-12">
                                    <input type="text" value="Bradfield park" class="form-control body-1 netural-100" name="name" id="InputName" required>
