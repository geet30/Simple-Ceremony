               ...
               <div class="row">
                  <div class="col-md-3 col-lg-3 col-xl-2 col-xxl-2 col-6">
                     <div class="position-relative mb-4">
                        @if ($data->image == '')
                        <img src="/images/admin-celebrants-profile.png" alt="Partner Image" class="img-fluid w-100 profile-image previewImage">
                        @else
                        <img src="/uploads/images/user/{{ $data->image }}" alt="Partner Image" class="img-fluid w-100 profile-image previewImage">
                        @endif

                        <img role="button" class="camera-icon position-absolute" style="bottom: 10px;right: 10px;" src="/images/admin/partner/camera-icon.svg" alt="Camera" onclick="browseImage(this,'imageInput')">
                     </div>
                  </div>

                  <div class="col-md-12 col-lg-9 col-xl-9 col-xxl-8">
                     <form class="needs-validation" method="POST" novalidate action="{{ route('updateCelebrantAccount') }}" id="updateCelebrantAccount" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                           ...
                           <div class="col-md-6 mb-4">
                              ...
                              <div class="invalid-feedback"> <span><img class="me-2" src="/images/require-iocn.svg" alt="Require Icon"></span>Username is required
                              </div>
                           </div>
                           <div class="col-md-6 mb-4">
                              ...
                              <div class="invalid-feedback"> <span><img class="me-2" src="/images/require-iocn.svg" alt="Require Icon"></span>First name is required
                              </div>
                           </div>
                           <div class="col-md-4 mb-4">
                              ...
                              <div class="invalid-feedback"> <span><img class="me-2" src="/images/require-iocn.svg" alt="Require Icon"></span>Preferred name is required
                              </div>
                           </div>
                           ...
                           <div class="col-md-4 mb-4 ">
                              ...
                              <div class=" position-relative">
                                 ...
                                 <input type="number" step="0.01" class="form-control body-1 netural-100 readonlyInput ps-4" id="standard_fee" value="{{ $data->celebrant->standard_fee ?? '' }}" name="celebrant[standard_fee]" readonly>
                              </div>
                           ...
                           <div class="col-md-4 mb-4 ">
                              ...
                              <div class="position-relative">
                                 ...
                                 <span class="currency-sign body-1 netural-100">$</span>
                                 <input type="number" step="0.01" class="form-control body-1 netural-100 readonlyInput ps-4" id="admin_fee" value="{{ $data->celebrant->admin_fee ?? '' }}" name="celebrant[admin_fee]" readonly>
                              </div>
                           </div>
                           <div class="col-md-6 mb-4">
                              ...
                              <div class="invalid-feedback"> <span><img class="me-2" src="/images/require-iocn.svg" alt="Require Icon"></span>Other name is required
                              </div>
                           </div>
                           <div class="col-md-6 mb-4">
                              ...
                              <div class="invalid-feedback"> <span><img class="me-2" src="/images/require-iocn.svg" alt="Require Icon"></span>Surname is required
                              </div>
                           </div>
                           <div class="col-md-6 mb-4">
                           ...
                           <div class="col-md-6 mb-4">
                              ...
                              <div class="invalid-feedback"> <span><img class="me-2" src="/images/require-iocn.svg" alt="Require Icon"></span>Address is required
                              </div>
                           </div>
                           ...
                           <div class="col-md-12 mb-4">
                              <div class="profile-form">
                                 ...
                                 <span class="body-2 netural-100 me-4">Follow up email performa</span>
                                 </div>
                                 <div class="ps-3">
                              <div class="col-md-12 mb-4">
                                 <label for="password" class="form-label small-text2">Subject</label>
                                 <input type="text" class="form-control body-1 netural-100 readonlyInput" name="celebrant[follow_subject]" id="follow_subject" value="{{ $data->celebrant->follow_subject ?? '' }}" required="" readonly>
                              </div>
                              
                              <div class="col-md-12">
                                 <label for="password" class="form-label small-text2">Subject</label>
                                 <textarea class="form-control body-1 netural-100 readonlyInput" id="follow_Description" rows="10" name="celebrant[follow_Description]" required="" readonly>{{ $data->celebrant->follow_Description ?? '' }}</textarea>
                              </div>
                              </div>
                              </div>
                           ...
                           <div class="row">
                              <div class="col-md-6 mb-4 d-flex flex-column position-relative">
                              
                                 <div class="drop-zone text-center celebrant-profile">
                                 @if($data->celebrant->image && !empty($data->celebrant->image))
                                    <?php 
                                 
                                       $path = asset('uploads/images/logos/'.$data->celebrant->image);
                                    ...
                                    ?>
                                    <div class="drop-zone__thumb" data-label="{{$data->celebrant->image}}" style="background-image: url({{$base64}})"></div>
                                 @else
                                    <span class="drop-zone__prompt text-center d-flex justify-content-center align-items-center h-100">
                                       <div class="me-3">
                                          <img src="/images/icons/uploading.svg" class="img-fluid mb-2" style="width: 70px;margin: 0 auto;">
                                          <p class="text mb-0">Compatible file .png </p>
                                       </div>
                                       <div class="text-start">
                                          <p class="document-text mb-2">Upload your logo here</p>
                                          <p class="small-text2 mb-0">This will appear in your invoice</p>
                                          <span class="darg dark-blue-100 h4 text-center">Drop or <span class="turquoise-100 text-decoration cursor-pointer">browse file</span></span>
                                       </div>
                                    </span>
                                 @endif
                           ...
                           <div class="col-md-12 mb-4 celebrantLocation">
                              <div class="row">
                                 <div class="col-md-12 mb-3 mt-4">
                                    <div class="d-flex flex-column flex-md-row">
                                       ...
                                       <a role="button" class="mt-2 mt-md-0 button-1 turquoise-100 text-decoration-none faq-link" data-bs-toggle="offcanvas" data-bs-target="#celebrant_addlocation" aria-controls="celebrant_addlocation">Add new
                                          location</a>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="row locDiv mb-2">
                                 <div class="col-10 col-sm-8 col-md-6"><input type="text" value="{{ $locations->location->name }}" readonly class="form-control body-1 netural-100 locationText">
                                    <input type="hidden" value='{{ $locations->location_id }}' name="locations[]">
                                 </div>
                                 <div class="col-2 col-sm-4 col-md-6"><a class="cross-icon" onclick="remove(`locDiv`,this)"><img src="/images/icons/cross.svg" class="img-fluid"></a></div>
                              </div>
                              @endforeach
                              @else
                           ...
                           <div class="col-md-12 mb-4">
                              ...
                              <button type="submit" class="d-inline-flex theme-btn primary-btn justify-content-center sticky-bottom d-none saveClass">Save
                              </button>
                           </div>
