...
<div class="container-fluid">
   <div class="row">
      ...
      <div class="col-10 col-md-9 col-lg-10 px-4">
         ...
         <a href="/addons/detail/{{$addonid}}" class="theme-btn secondary-btn-border d-inline-flex admin-back-btn mb-4"><img class="me-2" src="/images/icons/back.svg" alt="Back Icon">Back</a>
