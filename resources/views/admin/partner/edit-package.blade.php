                                       ...
                                       <div class="col-xl-10 col-xxl-7 mb-4">
                                          <div class="row">
                                             <div class="col-md-4 mb-4">
                                                ...
                                                <input type="number" step="0.01" onkeydown="return event.keyCode !== 69" value="{{ isset($package['partner_fee']) ? round($package['partner_fee'],0) : '' }}" class="form-control body-1 netural-100" name="partner_packages[{{$key}}][partner_fee]" id="InputName" required>
                                             ...
                                             <div class="col-md-4 mb-4">
                                                ...
                                                <input type="number" step="0.01" onkeydown="return event.keyCode !== 69" value="{{ isset($package['partner_fee']) ? round($package['partner_fee'],0) : '' }}" class="form-control body-1 netural-100" name="partner_packages[{{$key}}][admin_fee]"  id="InputName" required>
                                             ...
                                             <div class="col-md-4">
                                                ...
                                                <input type="number" step="0.01" onkeydown="return event.keyCode !== 69" value="{{ isset($package['partner_fee']) ? round($package['partner_fee'],0) : '' }}" class="form-control body-1 netural-100" name="partner_packages[{{$key}}][total_fee]" id="InputName" required>
                                       ...
                                       <div class="col-md-12">
                                          <div class="row">
                                             <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-4">
                                                ...
                                                <input type="number" step="0.01" onkeydown="return event.keyCode !== 69" value="{{ isset($package['deposit']) ? $package['deposit'] : '' }}" class="form-control body-1 netural-100"  name="partner_packages[{{$key}}][deposit]" id="InputName">
                                             </div>
                                             <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-4">
                                                <label for="InputName" class="form-label small-text2">Simulation partner fee</label>
                                                <input type="number" step="0.01" onkeydown="return event.keyCode !== 69" value="{{ isset($package['simulation_partner_fee']) ? round($package['simulation_partner_fee'],0) : '' }}" class="form-control body-1 netural-100" name="partner_packages[{{$key}}][simulation_partner_fee]" id="InputName" required>
                                             ...
                                             <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-4">
                                                ...
                                                <input type="number" step="0.01" onkeydown="return event.keyCode !== 69" value="{{ isset($package['simulation_admin_fee']) ? round($package['simulation_admin_fee'],0) : '' }}" class="form-control body-1 netural-100" name="partner_packages[{{$key}}][simulation_admin_fee]" id="InputName" required>
                                             ...
                                             <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-4">
                                                ...
                                                <div class="d-flex align-items-center">
                                                   <input type="number" step="0.01" onkeydown="return event.keyCode !== 69" value="{{ isset($package['simulation_total_fee']) ? round($package['simulation_total_fee'],0) : '' }}" class="form-control body-1 netural-100" name="partner_packages[{{$key}}][simulation_total_fee]" id="InputName" required>
