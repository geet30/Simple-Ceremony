...
<div class="container-fluid">
   <div class="row">
      ...
      <div class="col-10 col-md-9 col-lg-10 px-4">
         ...
         <a href="/partner-details" class="theme-btn secondary-btn-border d-inline-flex admin-back-btn mb-4"><img class="me-2" src="/images/icons/back.svg" alt="Back Icon">Back</a>
               ...
               <section class="pb-40">
                  <div class="row">
                     ...
                     <div class="col-md-6 align-self-center d-md-flex justify-content-md-end ">
                        ...
                        <a href="/edit-package" class="theme-btn primary-btn-border d-md-inline-flex"><img src="/images/icons/edit-primary.svg" alt="Edit" class="me-2">Edit Package</a>
                        </div>
                     </div>
                  </div>
               </section>
