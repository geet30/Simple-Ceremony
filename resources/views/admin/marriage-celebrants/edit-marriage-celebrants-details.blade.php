                    ...
                    <div class="col-lg-8 col-xl-9 col-xxl-10 mb-3 mb-lg-0">
                        <ul class="nav theme-tabs" role="tablist">
                            <li class="nav-item" role="presentation">
                               <a class="nav-link active" id="information-tab" data-bs-toggle="tab" data-bs-target="#information" href="#" aria-selected="true" role="tab">Availability &amp; schedule</a>
                            </li>
                            <li class="nav-item" role="presentation">
                               <a class="nav-link" id="celebrants-tab" data-bs-toggle="tab" data-bs-target="#celebrants" href="#" aria-selected="false" role="tab" tabindex="-1">Personal data</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-4 col-xl-3 col-xxl-2">
                        <a role="button" data-bs-toggle="modal" data-bs-target="#delete_alert" class="theme-btn primary-btn-border d-flex justify-content-center">Delete account</a>
                    </div>
                 </div>
                        ...
                        <div class="row">
                           <div class="col-md-3 col-lg-3 col-xl-2 col-xxl-2 col-6">
                              <div class="position-relative mb-4">
                                 <img src="/images/admin-celebrants-profile.png" alt="Partner Image" class="img-fluid w-100 profile-image">
                              ...
                              <form class="needs-validation" method="POST" novalidate>
                                 <div class="row">
                                    <div class="col-md-12 mb-4">
                                       <div class="table-dropdown d-flex align-items-md-center flex-column flex-md-row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                     ...
                                     <div class="col-md-6 mb-4">
                                        <label for="InputName" class="form-label small-text2 ms-2">Admin fee</label>
