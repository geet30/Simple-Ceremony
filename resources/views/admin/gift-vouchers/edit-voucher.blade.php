   ...
   <div class="row">
      ...
      <div class="col-10 col-md-9 col-lg-10 px-4">
         ...
         <div class="row">
            ...
            <a href="index" class="theme-btn secondary-btn-border d-inline-flex admin-back-btn mb-4"><img class="me-2" src="/images/icons/back.svg" alt="Back Icon">Back</a>
            </div>
            <div class="col-md-12">
                  ...
                  <div class="card-body">
                     <form class="row needs-validation" method="POST" novalidate action="">
                        ...
                        <div class="col-md-6 mb-4">
                              ...
                              <input type="text" name="voucher_title" class="form-control body-1 netural-100" value="Title voucher" required>
                        ...
                        <div class="col-md-6 mb-4">
                           ...
                           <div class="position-relative">
                                 ...
                                 <input type="number" name="voucher_price" class="form-control body-1 netural-100 ps-4" value="$ 500"required>
                                 <div class="invalid-feedback" >
                        ...
                        <div class="col-md-6 mb-4">
                              ...
                              <input type="number" name="voucher_number" class="form-control body-1 netural-100" value="92101921" required>
                        ...
                        <div class="col-md-12 mb-15">
                           ...
                           <textarea class="form-control body-1 netural-100" id="voucherdescription" name="custom_terms" rows="10">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris quis neque in erat maximus vulputate a sit amet ipsum. Quisque
placerat, arcu at pellentesque fermentum, nunc nisl condimentum mi, eu tristique nibh leo non ante. Praesent nec rhoncus mi,
eu faucibus risus. Cras tristique a arcu ut aliquet. Praesent eu bibendum magna, sed congue nisl. Praesent consequat tortor eget
justo dignissim, eget vehicula sapien blandit.</textarea>
                        </div>
