                  ...
                  <div class="card-body">
                     <form class="row needs-validation" method="POST" novalidate action="">
                        ...
                        <div class="col-md-6 mb-4">
                              ...
                              <input type="text" name="voucher_title" class="form-control body-1 netural-100" placeholder="Type title here" required>
                        ...
                        <div class="col-md-6 mb-4">
                           ...
                           <div class="position-relative">
                                 ...
                                 <input type="number" name="voucher_price" class="form-control body-1 netural-100 ps-4" placeholder="Type price here"required>
                                 <div class="invalid-feedback" >
