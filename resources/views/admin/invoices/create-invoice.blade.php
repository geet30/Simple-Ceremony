                  ...
                  <div class="row align-items-center">
                     ...
                     <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3 mb-4">
                        ...
                        <div class="d-flex align-items-center">
                           <input type="number" onkeydown="return event.keyCode !== 69" placeholder="ABN number" class="form-control body-1 netural-100 abn_number commonFirstEmpty" name="abn_number" readonly>
