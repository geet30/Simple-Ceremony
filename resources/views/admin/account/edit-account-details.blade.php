                     ...
                     <form class="needs-validation" method="POST" novalidate>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-4 col-lg-6 col-xl-5 col-xxl-4 mb-4 align-self-center">
                              ...
                              <a href="#" class="button-1 turquoise-100 faq-link d-block" data-bs-toggle="offcanvas" data-bs-target="#admin_change_password_sidebar">Change password</a>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-md-10 col-lg-6 col-xl-5 col-xxl-4 mb-4">
...
@include('elements.admin.account.partner-password-change-sidebar')
@endsection