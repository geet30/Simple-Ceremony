               ...
               <div class="card panel-card mb-5">
                  <div class="card-body">
                        <form class="needs-validation" method="POST" novalidate
                                    action="{{ route('all-type-of-ceremonies.update',$id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                           <div class="col-md-6 mb-4">
                              <label class="form-label small-text2">Type of ceremony</label>
                              <input type="text" name="ceremony_name" class="form-control body-1 netural-100" placeholder="Type of ceremony here" value="{{ $detail->ceremony_name }}" required>
                           ...
                           <div class="col-md-6 mb-4">
                              ...
                              <div class="position-relative">
                                  ...
                                  <input type="number" value="{{ $detail->fee_adjustment }}" name="fee_adjustment" class="form-control body-1 netural-100 ps-4" required>
                                  <div class="invalid-feedback" >
                           ...
                           <div class="col-md-12 mb-4">
                              ...
                              $additional_info =[];
                              if(isset($detail->additional_info) && !empty($detail->additional_info)){
                                 foreach($detail->additional_info as $info){
