...
<div class="container-fluid">
                     ...
                     <form action="">
                        <div class="row">
                           ...
                           <div class="col-md-12 mb-4">
                              ...
                              <a data-bs-toggle="offcanvas" data-bs-target="#edit-hyperlink" role="button" class="small-text1 text-decoration-none turquoise-100">
   ...
   @include('elements.admin.type-ceremonies.edit-hyperlink')
   @endsection