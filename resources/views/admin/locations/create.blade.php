                     ...
                     <form class="row g-3 needs-validation" novalidate  method="POST" action="{{url('store-location')}}" enctype="multipart/form-data">
                      ...
                      <input type="hidden" name="custom_location_id" value="{{ isset($data['id']) ? $data['id'] : '' }}">
                        ...
                        <div class="col-md-5 mb-4">
                           ...
                           <input type="number" onkeydown="return event.keyCode !== 69"  step="any" placeholder="Type Google coordinates here" class="form-control body-1 netural-100" name="latitude" id="latitude" value="{{ isset($data['latitude']) ? $data['latitude'] : old('latitude') }}" required>
                           <div class="invalid-feedback">
                        ...
                        <div class="col-md-5 mb-4">
                           ...
                           <input type="number" onkeydown="return event.keyCode !== 69"  step="any" placeholder="Type Google coordinates here" class="form-control body-1 netural-100" name="longitude" id="longitude" value="{{ isset($data['longitude']) ? $data['longitude'] : old('longitude') }}" required>
                           <div class="invalid-feedback">
