        ...
        <div class="row">
            ...
            <div class="col-10 col-md-9 col-lg-10 px-4">
                ...
                <div class="col-12 pt-20 pb-32 d-flex justify-content-center upcomming-marriage-top">
                    <a class="position-relative " type="button" data-bs-toggle="collapse"
                    ...
                    <div class="col-md-7 col-xl-8 d-flex align-self-center">
                        <div class="dropdown">
                            ...
                            <div class="select-with-checkbox">
                                <select name="filter_by_categories" id="selectinput"
                                    class="js-placeholder-single-input js-select2 form-control location_categories_button filter_by_categories"
                                    multiple="multiple">
                        ...
                        <div class="form-group has-search w-100 ms-4 position-relative">
                            <input type="text" class="form-control" placeholder="Search couple or celebrant"
                                onkeyup="searchWithTabs('/marriages/search-by-user',this.value)">
