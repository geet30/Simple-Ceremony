                        ...
                        <div class="col-lg-12 col-xl-12 col-xxl-12">
                            <div class="row">
                                <div class="col-lg-12 col-xl-12 col-xxl-12">
                                    <div class="row">
                                        <div class="col-md-4 mb-4">
                                            <label for="InputName" class="form-label small-text2">Preferred name</label>
                                            <input type="text" value="Johny" class="form-control body-1 netural-100" name="name" id="InputName" required>
                                         ...
                                         <div class="col-md-4 mb-4">
                                            ...
                                            <input type="text" value="Johny@gmail.com" class="form-control body-1 netural-100" name="name" id="InputName" required>
                                         ...
                                         <div class="col-md-4 mb-4 align-self-end">
                                            <a class="theme-btn primary-btn border-0 d-inline-block" role="button">Edit</a>
                                         </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-xl-10 col-xxl-8">
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                         ...
                                         <div class="col-md-6 mb-4">
                                            <label for="selectinput" class="form-label small-text2">Event start time</label>
                                ...
                                <div class="col-lg-12 col-xl-10 col-xxl-8">
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <input type="text" value="Bradfield Park North" class="form-control body-1 netural-100" name="name" id="InputName" required>
                                ...
                                <div class="col-lg-12 col-xl-10 col-xxl-8">
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <input type="text" value="Milsons Point NSW 2061, Australia" class="form-control body-1 netural-100" name="name" id="InputName" required>
                                ...
                                <div class="col-lg-12 col-xl-10 col-xxl-8">
                                    <div class="row">
                                        <div class="col-md-4 mb-4">
                                            ...
                                            <input type="text" value="New South Wales" class="form-control body-1 netural-100" name="name" id="InputName" required>
                                         ...
                                         <div class="col-md-4 mb-4">
                                            ...
                                            <input type="text" value="2070" class="form-control body-1 netural-100" name="name" id="InputName" required>
                                ...
                                <div class="col-lg-12 col-xl-10 col-xxl-8">
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <input type="text" value="Lorem ipsum dolor sit amet" class="form-control body-1 netural-100" name="name" id="InputName" required>
                                ...
                                <div class="col-lg-12 col-xl-10 col-xxl-8">
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <input type="text" value="090909090909" class="form-control body-1 netural-100" name="name" id="InputName" required>
                                ...
                                <div class="col-lg-12 col-xl-10 col-xxl-8">
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <input type="text" value="$ 5" class="form-control body-1 netural-100" name="name" id="InputName" required>
                                ...
                                <div class="col-lg-12 col-xl-10 col-xxl-8">
                                    <div class="row">
                                        <div class="col-12">
                                            <button type="submit" id="submit_button" class="theme-btn primary-btn border-0">Confirm</button>
                                         </div>
                                    </div>
                                </div>
                             </div>
