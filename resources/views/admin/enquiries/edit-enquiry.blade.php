                     ...
                     <form class="needs-validation" method="POST" novalidate>
                        <div class="row">
                           <div class="col-md-6 mb-4">
                              ...
                              <input type="text" value="David" class="form-control body-1 netural-100" name="name" id="InputName" required>
                           ...
                           <div class="col-md-6 mb-4">
                              ...
                              <input type="text" value="Sarah" class="form-control body-1 netural-100" name="name" id="InputName" required>
                           ...
                           <div class="col-md-6 mb-4">
                              ...
                              <input class="form-control body-1 netural-100" type="tel" id="phone" placeholder="e.g. +1 702 123 4567" value="+61 0000000000" required>
